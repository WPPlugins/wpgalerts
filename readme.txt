...
WPGAlerts checks the alerts whenever you open the WordPress/WPGAlerts menu and updates the articles available. Because of this, any article that is currently listed on the alert will be automatically replaced when you attempt to delete it. The only way to remove the article is to (a) wait for the article to no longer be listed on the alert feed and then delete it or (b) delete the feed and then delete the article.
